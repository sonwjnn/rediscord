  ...
  return useMutation({
    mutationFn: async (username: string): Promise<FriendActionResponse> => {
      const response = await fetch(
        `/api/socket/friends/send?userId=${currentUser?.id}`,
        {
          method: 'POST',
          headers: {
...
export const useAcceptFriendRequest = () => {
  ...
  return useMutation({
    mutationFn: async (friendId: string): Promise<FriendActionResponse> => {
      const response = await fetch(
        `/api/socket/friends/accept/${friendId}?userId=${currentUser?.id}`,
        {
          method: 'PATCH',
        }
      )
...
export const useRejectFriendRequest = () => {
  ...
  return useMutation({
    mutationFn: async (friendId: string): Promise<FriendActionResponse> => {
      const response = await fetch(
        `/api/socket/friends/reject/${friendId}?userId=${currentUser?.id}`,
        {
          method: 'PATCH',
        }
      )
...
export const useCancelFriendRequest = () => {
  ...
  return useMutation({
    mutationFn: async (friendId: string): Promise<FriendActionResponse> => {
      const response = await fetch(
        `/api/socket/friends/cancel/${friendId}?userId=${currentUser?.id}`,
        {
          method: 'DELETE',
        }
      )
...
export const useDeleteFriend = () => {
  ...
  return useMutation({
    mutationFn: async (friendId: string): Promise<FriendActionResponse> => {
      const response = await fetch(
        `/api/socket/friends/delete/${friendId}?userId=${currentUser?.id}`,
        {
          method: 'DELETE',
        }
      )
