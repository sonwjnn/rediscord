  ...
  if(!friends || friends.length === 0) {
    return (
      <div className="h-[80vh] w-full flex flex-col items-center justify-center text-center p-4">
        ...
        <h3 className="text-lg font-medium text-zinc-600 dark:text-zinc-200 mb-1">No Online Friends</h3>
        <p className="text-sm text-zinc-500 dark:text-zinc-500 mb-4">None of your friends are currently online</p>
        <Link 
