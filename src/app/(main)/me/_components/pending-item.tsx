...
} from '@/features/friends/api/use-friend-actions'
          ...
          <div className="ml-auto flex items-center gap-x-2">
            {type === 'incoming' && (
              <>
                <button
                  onClick={onAccept}
                  disabled={isLoading}
                  className="flex items-center rounded-full bg-green-700 p-2 text-sm font-medium text-white transition hover:bg-green-600 disabled:opacity-50"
                >
                ...
                <button
                  onClick={onReject}
                  disabled={isLoading}
                  className="flex items-center rounded-full p-2 text-sm font-medium text-white transition hover:bg-rose-600 disabled:opacity-50"
                >
                  <X className="size-5 " />
                </button>
              </>
            ...
            {type === 'outgoing' && (
              <button
                onClick={onCancel}
                disabled={isLoading}
                className="flex items-center gap-x-1 rounded-full bg-neutral-700/50 p-2 text-sm font-medium text-zinc-400 transition hover:bg-zinc-600 hover:text-white disabled:opacity-50"
              >
                <X className="size-5 " />
              </button>
            )}
